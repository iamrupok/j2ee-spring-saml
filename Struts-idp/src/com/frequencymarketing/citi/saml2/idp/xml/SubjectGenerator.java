...
public class SubjectGenerator {
	...
	public Subject generateSubject( String recepientAssertionConsumerURL, int validForInMinutes, String subjectName,  String inResponseTo, String clientAddress) {
		...
		subjectConfirmationData.setNotOnOrAfter(timeService.getCurrentDateTime().plusMinutes(validForInMinutes));
