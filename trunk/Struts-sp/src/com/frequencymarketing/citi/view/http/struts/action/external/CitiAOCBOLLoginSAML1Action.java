...
public class CitiAOCBOLLoginSAML1Action extends Action {
	    ...
	    public ActionForward execute(ActionMapping mapping, ActionForm form,
	        ...
	        System.out.println(loginSAMLResponse);
	       
	        CitiPortalSaml citiPortalSaml2 = (CitiPortalSaml)SpringContext.getBean("citiPortalSaml");
	    	
	    	//MemberSAMLSponsorAccountsData loginData = citiPortalSaml2.processCitiLoginResponseSAML2UsingPostBindingAdapter(request);
	        
	        
	      
	        String saml2Response = citiPortalSaml2.processCitiLoginResponse(loginSAMLResponse).toString() ;
